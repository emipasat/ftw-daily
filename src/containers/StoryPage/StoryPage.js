...
export class StoryPageComponent extends Component {
  ...
  render() {
    ...
    const paragraph2Ro_1 = `Locul cu o istorie care impresionează a servit de-a lungul anilor sub diverse forme: întâi
      sat de vacanță al presei comuniste, apoi preventoriu, orfelinat, școală și, ulterior,
      sanatoriu. După eforturi considerabile, proprietarii actuali îl recuperează în anul 2005,
      iar de 15 ani locul ce spune povestea generațiilor este în continuă conservare și
      reabilitare. Proiectul de refacere a fost și încă este însă o demonstrație de respect
    ...
    const paragraph2Ro_2 = `Vizita la Zabola nu este doar un concediu. Este mai degrabă o experiență epică, care
      așteaptă să fie descoperită. Este o atracție turistică diferită, inedită, spectaculoasă. De
      la interior, spre exterior și împrejurimi, vei pătrunde într-o incursiune în timp și spațiu, o
      lecție de geografie pentru toate vârstele și o școală a emoțiilor autentice.`;

    const paragraph2En_2 =  
                  `Visiting Zabola is more than a simple vacation, it is indeed an epic experience, which is
                  awaiting to be discovered. A tourist attraction defined by unicity, spectacularity and its
                  unexpected diversity. From the insides to the exteriors to the natural surroundings every
                  step is an immersion in time and space, a history lesson for all ages, and an authentic
    ...
    // const paragraph2Ro_3 = `Locul cu o istorie care impresionează a servit de-a lungul anilor sub diverse forme: întâi
    //   sat de vacanță al presei comuniste, apoi preventoriu, orfelinat, școală și, ulterior,
    //   sanatoriu. După eforturi considerabile, proprietarii actuali îl recuperează în anul 2005,
    //   iar de 15 ani locul ce spune povestea generațiilor este în continuă conservare și
    //   reabilitare. Proiectul de refacere a fost și încă este însă o demonstrație de respect
    ...
    var paragraph3Ro_1 = `Încă de la primul pas în Hotel vei intra într-o lume aparte, unde fiecare cameră este un
        ...
        confortul șederii.`
    var paragraph3En_1 =  `When you enter the hotel a unique world will be uncovered, where each room tells a
      ...
      var paragraph3Ro_2 = `Zona din afara hotelului, în imediata sa apropiere, îți va da senzația că ești un prinț sau
      ...
      var paragraph3En_2 =  `The surroundings will make you feel a royalty high, a carriage pulled by horses will
    ...
    var paragraph4Ro_1 = `Iar vizita ta epică nu se încheie aici!`
    var paragraph4En_1 =  `Your journey doesn't end here!`;

    var paragraph4Ro_2 = `Împrejurimile sunt o mină de aur pentru exploratori: de la apele minerale naturale
                    ...
                    neuitat.`
    var paragraph4En_2 =  `The natural landscapes are a gold mine for the explorers: from the crystal clear mineral
    ...
    var paragraph4Ro_3 = `Deși Zabola dăinuie sub sloganul "Transylvania's best kept secret", ne-am decis să
    ...
    var paragraph4En_3 =  `Although Zabola’s motto is &quot;Transylvania&#39;s best-kept secret&#39;&#39;, we decided to share this
    ...
    var paragraph4Ro_4 = `Pentru că vizita la Zabola este întotdeauna o vacanță personalizată, i-am întrebat pe
                    ...
                    culcare”.`
    var paragraph4En_4 =  `Because the visit at Zabole is always a personalized vacation, we asked the owners
    ...
    const paragraph5Ro_1 = `O astfel de zi trebuie să existe în albumul de amintiri al fiecărei persoane, tocmai de
    ...
    const paragraph5En_1 = 
      ...
      You can choose between the packages:`;


    const paragraph5Ro_2 = `"Vacanță Unică la Zabola Estate (3 Nopți)"` 
    const paragraph5En_2 = `"History and Wildlife Stories"`;


  const paragraph5Ro_3 = ` (pentru trei zile și trei nopți în care să explorezi, alături
    de cineva drag, atât istoria locului, cât și viața sălbatică ce se așterne la poalele lui),
    pachetul ` 
  const paragraph5En_3 = ` (explore the local history and enjoy the wildlife and beauty of the surroundings), `;


    const paragraph5Ro_4 = `"Bixad- Sejur Minunat la o Cabană de Vânătoare (3 Nopți)"` 
    const paragraph5En_4 =  `"Bixad- Amazing Holiday in a Hunting Lodge (3 Nights)"`;


    const paragraph5Ro_5 = ` (unde accentul va cădea timp de 3 zile pe frumusețea naturii) sau pachetul ` 
    const paragraph5En_5 =  `(get closer to the royal nature around you for three days)`;

    const paragraph5Ro_6 = `"Zăbala- Aventură Nobiliară Ecvestră (3 Nopți)"` 
    const paragraph5En_6 = `"Royal Equestrian Adventure"`;
  

    const paragraph5Ro_7 = `(o aventură pentru pasionații de călărie, timp de 3 zile).
    Alegerea ideală pentru o escapadă romantică o reprezintă pachetul ` 

    const paragraph5En_7 =  ` (an adventure for 3 days).
      If you’re looking for a romantic escape, the ideal choice would be `;


    const paragraph5Ro_8 = `"Transilvania- Cea Mai Bună Escapadă Romantică (2 Nopți)"` 
    const paragraph5En_8 = `"Transylvania- The Best Romantic Retreat"`;

    const paragraph5Ro_9 = ` iar dacă vreți să călătoriți alături de familie sau prieteni, puteți opta pentru  ` 
    const paragraph5En_9 =  ` and if you’re travelling with your family/friends, take a look at `;





    const paragraph5Ro_10 = `"Zabala- Experiența The Old Saddle House!"` 
    const paragraph5En_10 = `"Zabala- The Old Saddle House Experience"`;

    
      const paragraph5Ro_11 = `, ideală pentru 4-8 persoane.` 
      const paragraph5En_11 =  ` which can accomodate up to 8 people.`;
  


    const paragraph5Ro_12 = `Ești gata pentru o expediție în România, acolo unde magia se desprinde de realitate?` 
    const paragraph5En_12 = `Are you ready for the autumn expedition, ready to discover the Romanian nature where
      the reality of the mundane is replaced by a fairytale experience?`;



    const paragraph5Ro_13 = `Te așteptăm să fii scriitorul unui nou capitol și te provocăm să împărtășești cu noi
    experiențele.` 
    const paragraph5En_13 = 
    ...
    const paragraph5Ro_14 = `Iar povestea va continua` 
    const paragraph5En_14 = `And the story will go on...`;
...
<br/>
                ...
                <a href="https://www.epicvisits.com/l/zabala-history-and-wildlife-stories-3-nights/5f465078-ac91-4826-8395-b9e02150c4e0">
                {config.locale === 'ro' ? 
                ( paragraph5Ro_2)
                : 
                ( paragraph5En_2)
                ...
                <a href="https://www.epicvisits.com/l/bixad-a-dive-into-the-virgin-forest-3-nights/5f4fa7e9-6dc7-4766-8545-85df7cbd610e">
                {config.locale === 'ro' ? 
                ( paragraph5Ro_4)
                : 
                ( paragraph5En_4)
                ...
                <a href="https://www.epicvisits.com/l/zabala-royal-equestrian-adventure-3-days/5f464dd9-a540-4430-8821-f3a0c231b8d9">
                {config.locale === 'ro' ? 
                ( paragraph5Ro_6)
                : 
                ( paragraph5En_6)
                ...
                <a href="https://www.epicvisits.com/l/transylvania-the-best-romantic-retreat/5fa2b863-24b6-4beb-a04c-6e74b94d66f4">
                {config.locale === 'ro' ? 
                ( paragraph5Ro_8)
                : 
                ( paragraph5En_8)
                ...
                <a href="https://www.epicvisits.com/l/zabala-the-old-saddle-house-experience-4-8-pers/5f9fbd8a-6cb5-4df0-bda4-9b3e86e1f9fd">
                {config.locale === 'ro' ? 
                ( paragraph5Ro_10)
                : 
                ( paragraph5En_10)
      ...
      <a href="https://youtu.be/KxQFxRWwg70" target="_blank"><i>
                {config.locale === 'ro' ? 
                ( paragraph5Ro_14)
                : 
                ( paragraph5En_14)
