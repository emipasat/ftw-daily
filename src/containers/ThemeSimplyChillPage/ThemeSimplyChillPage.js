...
import css from './ThemeSimplyChillPage.css';
import image from './simply_chill.jpg';

const ThemeSimplyChillPage = () => {
  ...
  return (
    <StaticPage
      ...
      schema={{
        ...
        '@type': 'ThemeSimplyChillPage',
        description: 'Simply Chill',
        name: 'Theme Simply Chill page',
      }}
    >
      <LayoutSingleColumn>
        <LayoutWrapperTopbar>
        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          ...
          <div className={css.contentWrapper}>
            ...
            <div className={css.contentMain}>
              ...
              <p>
              Tired, stressed, brainwashed? Ok, we know how that feels. You need a Great Do Nothing experience.  Where you can just relax and enjoy the little things in life that make you feel happy. Choose a memorable stay and experience all wrapped up in a thematic travel package.
...
export default ThemeSimplyChillPage;
