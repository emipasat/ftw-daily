...
import css from './ThemeRomanticEscapesPage.css';
import image from './romantic_escapes.jpg';

const ThemeRomanticEscapesPage = () => {
  ...
  return (
    <StaticPage
      ...
      schema={{
        ...
        '@type': 'ThemeRomanticEscapesPage',
        description: 'Romantic Escapes',
        name: 'Theme Romantic Escapes page',
      }}
    >
      <LayoutSingleColumn>
        <LayoutWrapperTopbar>
        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          <h1 className={css.pageTitle}>Romantic Escapes</h1>
          <img className={css.coverImage} src={image} alt="Romantic Escapes" />
...
export default ThemeRomanticEscapesPage;
