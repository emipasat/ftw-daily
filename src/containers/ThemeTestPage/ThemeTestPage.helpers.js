...
/*
export const createSearchResultSchema = (listings, intl) => {
  // Schema for search engines (helps them to understand what this page is about)
  // http://schema.org
  // We are using JSON-LD format
  const siteTitle = config.siteTitle;
  const schemaDescription = intl.formatMessage({ id: 'ThemeTestPage.schemaDescription' });
  const schemaTitle = intl.formatMessage(
    { id: 'ThemeTestPage.schemaTitle' },
    { siteTitle }
  );
