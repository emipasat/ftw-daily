...
import ThemeFilterComponent from './ThemeFilterComponent';
import { validFilterParams } from './ThemeTestPage.helpers';
...
/**
 * MainThemePanel contains search results and filters.
 ...
 */
class MainThemePanel extends Component {
  constructor(props) {
    super(props);
