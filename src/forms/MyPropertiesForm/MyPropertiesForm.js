...
import css from './MyPropertiesForm.css';

const SHOW_EMAIL_SENT_TIMEOUT = 2000;

class MyPropertiesFormComponent extends Component {
  constructor(props) {
    super(props);
...
MyPropertiesFormComponent.defaultProps = {
  rootClassName: null,
  className: null,
  formId: null,
  saveEmailError: null,
...
MyPropertiesFormComponent.propTypes = {
