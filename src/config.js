...
const addressCountry = 'RO';
const addressRegion = 'Brasov';
const postalCode = '077180';
...
const siteTitle = 'Epicvisits';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@epicvisits';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = null;

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/Epic-Visits-100389395026046/';
